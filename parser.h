...
struct parser {
	...
	parser_err_t (*read_data )(void *storage, const void *data, unsigned int len);		/* read a block of data */
	parser_err_t (*write_data)(void *storage, const void *data, unsigned int len);		/* write a block of data */
};
